import { loot } from "./loot.js";
    ...
    function postloot() {
        ...
        lootbox.append("<img src=" + randLoot.img + ">").append("<br>").append("<p class = randlootname>" + randLoot.name + "</p>").append("<br>").append("<p class = randlootprice>" + price + "₽" + "</p>").append("<br>").append("<button id = sell>" + "Quick Sell" + "</button>").append("<br>").append("<button id = stash>" + "Stash" + "</button>");
